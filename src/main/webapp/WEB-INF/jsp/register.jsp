...
<div class="container">
    ...
    <form class="form-horizontal" id="form_register" role="form" action="/register" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="aihao"
        ...
        <div class="form-group" style="display: none">
            ...
            <div class="col-sm-9">
                <div class="col-xs-4" style="margin-left: -15px;">
                    <input class="form-control code" type="text" placeholder="" value="12345"
        ...
        <div class="form-group margin-top-40">
            <div class="col-sm-offset-3 col-sm-10">
                <button type="submit" class="btn btn-info" id="login-submit">Register
                </button>
                &nbsp;
